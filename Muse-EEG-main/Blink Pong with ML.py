...
sample_nr = 0
expected_samples = 60                                           # there are 5 frequencies (alpa...gamma) and 4 sensors, if all 4 sensors are used
...
def initiate_tf():
    ...
    path = "Models/"
    lite_file = "ei-lslsls0001_3-nn_3-classifier-tensorflow-lite-float32-model.lite"

    ####################### INITIALIZE TF Lite #########################
    # Load TFLite model and allocate tensors.
    interpreter = tf.lite.Interpreter(model_path = path + lite_file, experimental_preserve_all_tensors=True)
